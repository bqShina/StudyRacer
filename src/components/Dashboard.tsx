...
const Dashboard: React.FC = () => {
    return (
        <div className="container mx-auto px-4 py-12">
            <h1 className="text-5xl font-bold mb-12 gradient-text text-center">Welcome to StudyRacer</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="card hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <p className="mb-6 text-gray-600 dark:text-gray-300">Stay on top of your assignments and watch your performance improve over time.</p>
                ...
                <div className="card hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <p className="mb-6 text-gray-600 dark:text-gray-300">Join the leaderboard and challenge yourself to reach the top.</p>
